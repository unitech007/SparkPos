...
{        
    public interface IPaymentCreditProductRepository : IBaseRepository<PaymentCreditProduct>
    {
        int Save(PaymentCreditProduct obj, bool isSaveFromSales);
        int Update(PaymentCreditProduct obj, bool isUpdateFromSales);
