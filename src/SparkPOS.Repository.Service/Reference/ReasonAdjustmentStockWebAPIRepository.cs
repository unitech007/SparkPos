...
{        
    public class ReasonAdjustmentStockWebAPIRepository : IReasonAdjustmentStockRepository
    {
        private string _apiUrl = string.Empty;
        private ILog _log;
		
        public ReasonAdjustmentStockWebAPIRepository(string baseUrl, ILog log)
        {
            this._apiUrl = baseUrl + "api/alasan_penyesuaian_stock/";
            this._log = log;
        }
        ...
        public ReasonAdjustmentStock GetByID(string id)
        {
			...
			try
            {
                ...
                var response = RestSharpHelper<SparkPOSWebApiGetResponse<ReasonAdjustmentStock>>.GetRequest(_apiUrl, api).Data;
