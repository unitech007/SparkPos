...
{
    public class TaxWebAPIRepository : ITaxRepository
    {
        private string _apiUrl = string.Empty;
        private ILog _log;

        public TaxWebAPIRepository(string baseUrl, ILog log)
        {
        ...
        public Tax GetByID(string id)
        {
            ...
            try
            {
                ...
                var response = RestSharpHelper<SparkPOSWebApiGetResponse<Tax>>.GetRequest(_apiUrl, api).Data;
        ...
        public void ClearDefaultTax(Guid currentTaxId)
        {
