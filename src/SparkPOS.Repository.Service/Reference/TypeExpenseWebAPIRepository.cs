...
{
    public class TypeExpenseWebAPIRepository : ITypeExpenseRepository
    {
        private string _apiUrl = string.Empty;
        private ILog _log;

        public TypeExpenseWebAPIRepository(string baseUrl, ILog log)
        {
            this._apiUrl = baseUrl + "api/type_expense/";
            this._log = log;            
        }
        ...
        public TypeExpense GetByID(string id)
        {
            ...
            try
            {
                ...
                var response = RestSharpHelper<SparkPOSWebApiGetResponse<TypeExpense>>.GetRequest(_apiUrl, api).Data;
