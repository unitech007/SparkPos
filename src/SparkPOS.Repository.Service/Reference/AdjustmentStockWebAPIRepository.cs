...
{        
    public class AdjustmentStockWebAPIRepository : IAdjustmentStockRepository
    {
        private string _apiUrl = string.Empty;
        private ILog _log;
		
        public AdjustmentStockWebAPIRepository(string baseUrl, ILog log)
        {
            this._apiUrl = baseUrl + "api/penyesuaian_stock/";
            this._log = log;
        }
        ...
        public AdjustmentStock GetByID(string id)
        {
			...
			try
            {
                ...
                var response = RestSharpHelper<SparkPOSWebApiGetResponse<AdjustmentStock>>.GetRequest(_apiUrl, api).Data;
