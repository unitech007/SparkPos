    ...
    public class CustomerWebAPIRepository : ICustomerRepository
    {
        ...
        public Customer GetByID(string id)
        {
			...
			try
            {
                ...
                var response = RestSharpHelper<SparkPOSWebApiGetResponse<Customer>>.GetRequest(_apiUrl, api).Data;
        ...
        public IList<Customer> GetAll(bool isReseller)
        {
            ...
            try
            {
                var api = string.Format("get_by_type_customer?isReseller={0}", isReseller);
                var response = RestSharpHelper<SparkPOSWebApiGetResponse<Customer>>.GetRequest(_apiUrl, api).Data;
