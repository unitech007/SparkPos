...
{        
    ...
    {
        private const string SQL_TEMPLATE = @"SELECT m_role_privilege.role_id, m_role_privilege.grant_id, m_role_privilege.is_grant, m_menu.menu_id, m_menu.name_menu
        ...
        {
            IEnumerable<RolePrivilege> oList = _context.db.Query<RolePrivilege, MenuApplication, RolePrivilege>(sql, (rp, m) =>
            {
