...
{
    public class ReportSalaryEmployeeBll : IReportSalaryEmployeeBll
    {
        private ILog _log;
        private IUnitOfWork _unitOfWork;

        public ReportSalaryEmployeeBll(ILog log)
        {
            _log = log;
        }
        ...
        {
            IList<ReportSalaryEmployee> oList = null;

            using (IDapperContext context = new DapperContext())
            {
                _unitOfWork = new UnitOfWork(context, _log);
                oList = _unitOfWork.ReportSalaryEmployeeRepository.GetByMonth(month, year);
            }
        ...
        public IList<ReportSalaryEmployee> GetByDate(DateTime tanggalMulai, DateTime tanggalSelesai)
        {
            ...
            {
                _unitOfWork = new UnitOfWork(context, _log);
                oList = _unitOfWork.ReportSalaryEmployeeRepository.GetByDate(tanggalMulai, tanggalSelesai);
            }
