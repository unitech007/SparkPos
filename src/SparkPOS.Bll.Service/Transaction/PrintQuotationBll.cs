...
{
    public class PrintQuotationBll : IPrintQuotationBll
    {
        private ILog _log;
        private IUnitOfWork _unitOfWork;

        public PrintQuotationBll(ILog log)
        {
            _log = log;
        }
        ...
        public IList<QuotationSales> GetQuotationSales(string jualProductId)
        {
            ...
            using (IDapperContext context = new DapperContext())
            {
                ...
                oList = _unitOfWork.PrintQuotationRepository.GetQuotationSales(jualProductId);
            }
