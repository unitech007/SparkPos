...
{
    [TestClass]
    public class TitlesWebAPIBllTest
    {
        private ILog _log;
        ...
        public void Init()
        {
            ...
            _log = LogManager.GetLogger(typeof(TitlesWebAPIBllTest));
            _bll = new TitlesBll(true, baseUrl, _log);
        }
        ...
        public void UpdateTest()
        {
            var obj = new job_titles
            {
                job_titles_id = "df864174-857d-4746-876f-ca1d59fb4df8",
