...
{
    public partial class FrmQuotationSales : DockContent, IListener
    {
        ...
        public FrmQuotationSales(string header, User user, string menuId)
        {
            ...
            this._bll = new SellingQuotationBll(_log);            
            ...
            _currentInvoice = this._bll.GetLastQuotation();
...
//e.Style.CellValue = itemSelling.quantity - itemSelling.return_quantity;
        ...
        {
            var itemSelling = new ItemSellingQuotation();
        ...
        //    if (isShowConfirm)
        //    {
        //        var msg = "Apakah Anda ingin membatalkan transactions saat ini ?";
        ...
        //                        var frmListInvoice = new FrmLookupInvoice("Daftar Invoice", listOfSelling);
        ...
        //    }
        //    else if (data is SellingQuotation) // payment
        //    {
        ...
        //        else // data lebih dari one
        //        {
        //            var frmLookup = new FrmLookupReference("Data Pelanggan", listOfCustomer);
        //            frmLookup.Listener = this;
        //            frmLookup.ShowDialog();
        //        }
        //    }
