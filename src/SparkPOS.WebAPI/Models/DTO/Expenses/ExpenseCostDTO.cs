...
{        
    public class ExpenseCostDTO
    {
        public ExpenseCostDTO()
        {
            item_expense_cost = new List<ItemExpenseCostDTO>();
            item_expense_cost_deleted = new List<ItemExpenseCostDTO>();
        }
        ...
        public IList<ItemExpenseCostDTO> item_expense_cost { get; set; }

        public IList<ItemExpenseCostDTO> item_expense_cost_deleted { get; set; }
	}

    public class ExpenseCostDTOValidator : AbstractValidator<ExpenseCostDTO>
    {
        public ExpenseCostDTOValidator()
        {
