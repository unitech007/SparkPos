...
{        
    ...
    public class CustomerDTOValidator : AbstractValidator<CustomerDTO>
    {
        ...
        private void DefaultRule(string msgError1, string msgError2)
        {
            ...
            RuleFor(c => c.province_id).Length(0, 2).WithMessage(msgError2);
            RuleFor(c => c.regency_id).Length(0, 4).WithMessage(msgError2);
            RuleFor(c => c.subdistrict_id).Length(0, 7).WithMessage(msgError2);
