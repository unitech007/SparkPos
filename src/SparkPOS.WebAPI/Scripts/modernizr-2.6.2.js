...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /*jshint evil:true */
      ...
      /**
       * Returnns the value of `html5.elements` as an array.
       * @private
      ...
      function getElements() {
        ...
        /**
       * Returnns the data associated to the given document
       * @private
       * @param {Document} ownerDocument The document.
    ...
    /*>>hasevent*/
    // Modernizr.hasEvent() detects support for a given event, with an Optionalelement to test on
    ...
    // Returnn values will also be the camelCase variant, if you need to translate that to hypenated style use:
    //
