...
{
    public interface ICategoryController : IBaseApiController<CategoryDTO>
    {
    ...
    public class CategoryController : BaseApiController, ICategoryController
    {
        ...
        public CategoryController(IUnitOfWork unitOfWork, ILog log)
        {
            this._unitOfWork = unitOfWork;
            this._log = log;
        }
        ...
        public IHttpActionResult GetByName(string name, bool useLikeOperator = true)
        {
            ...
            try
            {
                var results = _unitOfWork.CategoryRepository.GetByName(name.NullToString(), useLikeOperator);
        ...
        public IHttpActionResult GetAll()
        {
            ...
            try
            {
                var results = _unitOfWork.CategoryRepository.GetAll();
        ...
        [HttpPost, Route("save")]
        public IHttpActionResult Save(CategoryDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                var obj = AutoMapper.Mapper.Map<Category>(objDTO);

                var result = _unitOfWork.CategoryRepository.Save(obj);
        ...
        public IHttpActionResult Update(CategoryDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                ...
                var result = _unitOfWork.CategoryRepository.Update(obj);
        ...
        public IHttpActionResult Delete(CategoryDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                ...
                var result = _unitOfWork.CategoryRepository.Delete(obj);
