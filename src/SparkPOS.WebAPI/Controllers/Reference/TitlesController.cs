...
{        
	public interface ITitlesController : IBaseApiController<TitlesDTO>
    {
        IHttpActionResult GetByID(string id);
        IHttpActionResult GetByName(string name);
    }

	[RoutePrefix("api/job_titles")]
    public class TitlesController : BaseApiController, ITitlesController
    {
        ...
        public TitlesController(IUnitOfWork unitOfWork, ILog log)
        {
            this._unitOfWork = unitOfWork;
            this._log = log;
        }
        ...
        public IHttpActionResult GetByID(string id)
        {
            ...
            try
            {
                var results = new List<job_titles>();
                var obj = _unitOfWork.TitlesRepository.GetByID(id);
        ...
        public IHttpActionResult GetAll()
        {
            ...
            try
            {
                var results = _unitOfWork.TitlesRepository.GetAll();
		...
		[HttpPost, Route("save")]
        public IHttpActionResult Save(TitlesDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                var obj = AutoMapper.Mapper.Map<job_titles>(objDTO);

                var result = _unitOfWork.TitlesRepository.Save(obj);
        ...
        public IHttpActionResult Update(TitlesDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                ...
                var result = _unitOfWork.TitlesRepository.Update(obj);
        ...
        public IHttpActionResult Delete(TitlesDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                ...
                var result = _unitOfWork.TitlesRepository.Delete(obj);
