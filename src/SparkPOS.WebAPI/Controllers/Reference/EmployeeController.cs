...
{        
	public interface IEmployeeController : IBaseApiController<EmployeeDTO>
    {
    ...
    public class EmployeeController : BaseApiController, IEmployeeController
    {
        ...
        public EmployeeController(IUnitOfWork unitOfWork, ILog log)
        {
            this._unitOfWork = unitOfWork;
            this._log = log;
        }
        ...
        public IHttpActionResult GetByID(string id)
        {
            ...
            try
            {
                ...
                var obj = _unitOfWork.EmployeeRepository.GetByID(id);
        ...
        public IHttpActionResult GetByName(string name)
        {
            ...
            try
            {
                var results = _unitOfWork.EmployeeRepository.GetByName(name.NullToString());
        ...
        public IHttpActionResult GetAll()
        {
            ...
            try
            {
                var results = _unitOfWork.EmployeeRepository.GetAll();
		...
		[HttpPost, Route("save")]
        public IHttpActionResult Save(EmployeeDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                var obj = AutoMapper.Mapper.Map<Employee>(objDTO);

                var result = _unitOfWork.EmployeeRepository.Save(obj);
        ...
        public IHttpActionResult Update(EmployeeDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                ...
                var result = _unitOfWork.EmployeeRepository.Update(obj);
        ...
        public IHttpActionResult Delete(EmployeeDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                ...
                var result = _unitOfWork.EmployeeRepository.Delete(obj);
