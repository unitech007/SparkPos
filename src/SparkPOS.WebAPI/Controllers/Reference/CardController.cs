...
{        
	public interface ICardController : IBaseApiController<CardDTO>
    {
    ...
    public class CardController : BaseApiController, ICardController
    {
        ...
        public CardController(IUnitOfWork unitOfWork, ILog log)
        {
            this._unitOfWork = unitOfWork;
            this._log = log;
        }
        ...
        public IHttpActionResult GetByID(string id)
        {
            ...
            try
            {
                ...
                var obj = _unitOfWork.CardRepository.GetByID(id);
        ...
        public IHttpActionResult GetAll()
        {
            ...
            try
            {
                var results = _unitOfWork.CardRepository.GetAll();
		...
		[HttpPost, Route("save")]
        public IHttpActionResult Save(CardDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                var obj = AutoMapper.Mapper.Map<Card>(objDTO);

                var result = _unitOfWork.CardRepository.Save(obj);
        ...
        public IHttpActionResult Update(CardDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                ...
                var result = _unitOfWork.CardRepository.Update(obj);
        ...
        public IHttpActionResult Delete(CardDTO objDTO)
        {
            _httpStatusCode = HttpStatusCode.BadRequest;
            _response = Content(_httpStatusCode, new ResponsePackage(_httpStatusCode));
            ...
            try
            {
                ...
                var result = _unitOfWork.CardRepository.Delete(obj);
