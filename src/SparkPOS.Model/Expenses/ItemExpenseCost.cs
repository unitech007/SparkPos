...
{        
    ...
    public class ItemExpenseCost
    {
        public ItemExpenseCost()
        {
        ...
        [JsonIgnore]
		[Write(false)]
        public ExpenseCost ExpenseCost { get; set; }
    ...
    public class ItemExpenseCostValidator : AbstractValidator<ItemExpenseCost>
    {
        public ItemExpenseCostValidator()
        {
