...
{        
    ...
    public class FooterInvoiceMiniPos
    {
		[ExplicitKey]
		[Display(Name = "footer_invoice_id")]		
		public string footer_invoice_id { get; set; }
    ...
    public class FooterInvoiceMiniPosValidator : AbstractValidator<FooterInvoiceMiniPos>
    {
        public FooterInvoiceMiniPosValidator()
        {
