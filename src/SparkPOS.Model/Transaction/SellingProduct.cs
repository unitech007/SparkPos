...
{        
    ...
    public class SellingProduct
    {
        ...
        {
            is_sdac = true;
            item_jual = new List<ItemSellingProduct>();
            item_jual_deleted = new List<ItemSellingProduct>();
        }
        ...
        [Write(false)]
        public List<ItemSellingProduct> item_jual { get; set; }

        [Write(false)]
        public List<ItemSellingProduct> item_jual_deleted { get; set; }
	}

    public class SellingProductValidator : AbstractValidator<SellingProduct>
    {
        public SellingProductValidator()
        {
