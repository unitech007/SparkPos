...
{
    [Table("t_purchase_order_item")]
    public class ItemPurchaseProduct
    {
        public ItemPurchaseProduct()
        {
    ...
    public class ItemPurchaseProductValidator : AbstractValidator<ItemPurchaseProduct>
    {
        public ItemPurchaseProductValidator()
        {
