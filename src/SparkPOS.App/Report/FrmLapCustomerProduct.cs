...
{
    public partial class FrmLapCustomerProduct : FrmSettingReportEmptyBody
    {
        private ILog _log;

        public FrmLapCustomerProduct(string header)
        {
             InitializeComponent(); 
        ...
        private void PreviewReport()
        {
            ...
            IList<ReportCustomerProduct> listOfReport;
            ...
            if (rdoDate.Checked)
            {
                ...
                listOfReport = reportBll.CustomerProductGetByDate(dtpDateMulai.Value, dtpDateSelesai.Value);
            }
            else
            {
                ...
                listOfReport = reportBll.CustomerProductGetByMonth(month, year);
            }
            ...
            if (listOfReport.Count > 0)
            {
                ...
                base.ShowReport(this.Text, "RvCustomerProduct", reportDataSource, parameters);
            }            
            else
            {
                MsgHelper.MsgInfo("Sorry report data customer product not found");
            }
        }
    }
}
