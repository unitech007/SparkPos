...
{
    public partial class FrmLapReturnProductSales : FrmSettingReportStandard
    {
        private IList<Customer> _listOfCustomer = new List<Customer>();
        private ILog _log;

        public FrmLapReturnProductSales(string header)
        {
             InitializeComponent();  
        ...
        private void PreviewReportHeader()
        {
            ...
            IReportReturnSellingProductBll reportBll = new ReportReturnSellingProductBll(_log);
            
            IList<ReportReturnSalesProductHeader> listOfReportCreditSales = new List<ReportReturnSalesProductHeader>();
            ...
            if (listOfReportCreditSales.Count > 0)
            {
                ...
                {
                    Name = "ReportReturnSalesProductHeader",
                ...
                base.ShowReport(this.Text, "RvReturnSalesProductHeader", reportDataSource, parameters);
            }
            else
            {
                MsgHelper.MsgInfo("Sorry report data return sales not found");
            }
        }
        ...
        private void PreviewReportDetail()
        {
            ...
            IList<ReportReturnSalesProductDetail> listOfReportCreditSales = new List<ReportReturnSalesProductDetail>();
            ...
            if (listOfReportCreditSales.Count > 0)
            {
                var reportDataSource = new ReportDataSource
                {
                    Name = "ReportReturnSalesProductDetail",
                    Value = listOfReportCreditSales
                };
                ...
                parameters.Add(new ReportParameter("periode", periode));
                SparkPOS.Helper.MainProgram.currentLanguage = MainProgram.currentLanguage;
                base.ShowReport(this.Text, "RvReturnSalesProductDetail", reportDataSource, parameters);
            }
            else
            {
                MsgHelper.MsgInfo("Sorry report data return sales not found");
