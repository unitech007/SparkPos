...
{
    public partial class FrmLapReturnProductPurchase : FrmSettingReportStandard
    {
        private IList<Supplier> _listOfSupplier = new List<Supplier>();
        private ILog _log;

        public FrmLapReturnProductPurchase(string header)
        {
             InitializeComponent();  
            ...
            chkShowInvoice.Text = "Show details return";
        ...
        private void PreviewReportHeader()
        {
            ...
            IReportReturnPurchaseProductBll reportBll = new ReportReturnPurchaseProductBll(_log);
                        
            IList<ReportReturnProductPurchaseHeader> listOfReportDebtPurchase = new List<ReportReturnProductPurchaseHeader>();
            ...
            if (listOfReportDebtPurchase.Count > 0)
            {
                ...
                {
                    Name = "ReportReturnProductPurchaseHeader",
                ...
                base.ShowReport(this.Text, "RvReturnProductPurchaseHeader", reportDataSource, parameters);
            }
            else
            {
                MsgHelper.MsgInfo("Sorry report data return Purchase not found");
            }
        }
        ...
        private void PreviewReportDetail()
        {
            ...
            IList<ReportReturnProductPurchaseDetail> listOfReportDebtPurchase = new List<ReportReturnProductPurchaseDetail>();
            ...
            if (listOfReportDebtPurchase.Count > 0)
            {
                var reportDataSource = new ReportDataSource
                {
                    Name = "ReportReturnProductPurchaseDetail",
                    Value = listOfReportDebtPurchase
                };
                ...
                parameters.Add(new ReportParameter("periode", periode));
                SparkPOS.Helper.MainProgram.currentLanguage = MainProgram.currentLanguage;
                base.ShowReport(this.Text, "RvReturnProductPurchaseDetail", reportDataSource, parameters);
            }
            else
            {
                MsgHelper.MsgInfo("Sorry report data return Purchase not found");
