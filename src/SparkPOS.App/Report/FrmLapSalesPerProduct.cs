...
{
    public partial class FrmLapSalesPerProduct : FrmSettingReportStandard
    {
        private IList<Customer> _listOfCustomer = new List<Customer>();
        private ILog _log;

        public FrmLapSalesPerProduct(string header)
        {
             InitializeComponent(); 
        ...
        private void PreviewReport()
        {
            ...
            if (rdoDate.Checked)
            {
                ...
                listOfReportSales = reportBll.PerProductGetByDate(dtpDateMulai.Value, dtpDateSelesai.Value);
            }
            else
            {
                ...
                listOfReportSales = reportBll.PerProductGetByMonth(month, year);
            }
            ...
            if (listOfReportSales.Count > 0)
            {
                ...
                base.ShowReport(this.Text, "RvSalesProduct", reportDataSource, parameters);
            }
            else
            {
