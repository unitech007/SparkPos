...
{
    public partial class FrmSalesPerCashier : FrmSettingReportEmptyBody
    {
        private ILog _log;

        public FrmSalesPerCashier(string header)
        {
             InitializeComponent(); 
        ...
        private void PreviewReport()
        {
            ...
            IList<ReportSalesPerCashier> listOfReportSales;
            ...
            if (rdoDate.Checked)
            {
                ...
                listOfReportSales = reportBll.PerCashierGetByDate(dtpDateMulai.Value, dtpDateSelesai.Value);
            }
            else
            {
                ...
                listOfReportSales = reportBll.PerCashierGetByMonth(month, year);
            }
            ...
            if (listOfReportSales.Count > 0)
            {
                ...
                base.ShowReport(this.Text, "RvSalesProductPerCashier", reportDataSource, parameters);
            }            
            else
            {
                MsgHelper.MsgInfo("Sorry report data sales per Cashier not found");
            }
        }
    }
}
