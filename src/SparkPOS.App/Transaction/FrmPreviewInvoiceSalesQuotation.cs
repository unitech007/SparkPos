...
{
    public partial class FrmPreviewInvoiceSalesQuotation : Form
    {
        ...
        private SellingQuotation _jual = null;
        private User _user;
        private Profil _profil;
        private GeneralSupplier _GeneralSupplier;
        public FrmPreviewInvoiceSalesQuotation()
        {
             InitializeComponent();  
        ...
        public FrmPreviewInvoiceSalesQuotation(string header, SellingQuotation sale)
            : this()
        {
            //this.Text = header;
        ...
        //private void PreviewInvoice(SellingQuotation sale, bool isPreview = true)
        //{
        //    try
        //    {
        ...
        private void PreviewInvoice(SellingQuotation sale, bool isPreview = true)
        {
            try
            {
                PrintQuotationBll printBll = new PrintQuotationBll(_log);
                var listOfItemInvoice = printBll.GetQuotationSales(sale.quotation_id);
       ...
       "QrCode_" + DateTime.Now.ToString("yyyyMMddHHmmssfff") + ".png"
                ...
                var reportName = sale.is_dropship ? "RvInvoiceSalesQuotationTanpaLabel - Copy" : "RvInvoiceSalesQuotationTanpaLabel - Copy";
        ...
        private void btnPrintInvoice_Click(object sender, EventArgs e)
        {
            if (MsgHelper.MsgConfirmation("Do you want to continue the printing process ?"))
            {
                using (new StCursor(Cursors.WaitCursor, new TimeSpan(0, 0, 0, 0)))
                {
                    ISellingQuotationBll bll = new SellingQuotationBll(_log);
        ...
        private void FrmPreviewInvoiceSalesQuotation_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void FrmPreviewInvoiceSalesQuotation_Load(object sender, EventArgs e)
        {
