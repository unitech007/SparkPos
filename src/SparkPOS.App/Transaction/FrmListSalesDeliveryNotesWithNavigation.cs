...
{
    public partial class FrmListSalesDeliveryNotesWithNavigation : FrmListEmptyBodyWithNavigation, IListener
    {
        private ISellingDeliveryNotesBll _bll; // deklarasi objek business logic layer 
        private IList<SellingDeliveryNotes> _listOfSelling = new List<SellingDeliveryNotes>();
        ...
        public FrmListSalesDeliveryNotesWithNavigation(string header, User user, string menuId)
            : base()
        {
             InitializeComponent();  
           ...
           _bll = new SellingDeliveryNotesBll(MainProgram.isUseWebAPI, MainProgram.baseUrl, _log);
            _user = user;
        ...
        private void InitGridList()
        {
            ...
            gridListProperties.Add(new GridListControlProperties { Header = "Delivery Notes", Width = 110});
            ...
            {
                gridListProperties.Add(new GridListControlProperties { Header = "Print Delivery Notes/Label", Width = 130 });
                gridListProperties.Add(new GridListControlProperties { Header = "" });
            }
            else
            {
                gridListProperties.Add(new GridListControlProperties { Header = "Print Delivery Notes", Width = 130 });
            }

         //   gridListProperties.Add(new GridListControlProperties { Header = "Invoice", Width = 150 });
            LanguageHelper.TranslateGridListControlHeaders(gridListProperties, MainProgram.currentLanguage);
            GridListControlHelper.InitializeGridListControl<SellingDeliveryNotes>(this.gridList, _listOfSelling, gridListProperties, false, rowHeight: 40);
                        ...
                        case 10: // print invoice sale
                            using (new StCursor(Cursors.WaitCursor, new TimeSpan(0, 0, 0, 0)))
                            {
                                ...
                                switch (this._GeneralSupplier.type_printer)
                                {
                                    ...
                                    default:
                                      var  frmPrintInvoice = new Transaction.FrmPreviewInvoiceSalesDeliveryNotes("Preview Invoice Delivery Notes", sale);
                    ...
                    if (e.RowIndex > 0)
                    {
                        ...
                        if (rowIndex < _listOfSelling.Count)
                        {
                            ...
                            switch (e.ColIndex)
                            {
                                ...
                                case 2:
                                    e.Style.HorizontalAlignment = GridHorizontalAlignment.Center;
                                    e.Style.CellValue = DateTimeHelper.DateToString(sale.delivery_date);
                                    break;
                                ...
                                case 3:
                                        ...
                                        e.Style.CellValue = sale.delivery;
                                        break;
                                ...
                                case 6:
                                        ...
                                        {
                                            e.Style.Description = "Print Delivery Notes";
                                        }
                                        else if (MainProgram.currentLanguage == "ar-SA")
                                        {
                                            e.Style.Description = "طباعة ملاحظات التسليم";
                                        }
                                ...
                                case 7:
                                        ...
                                        e.Style.HorizontalAlignment = GridHorizontalAlignment.Right;
                                        e.Style.CellValue = sale.total_invoice;
                                        break;
        ...
        private void LoadData()
        {
            using (new StCursor(Cursors.WaitCursor, new TimeSpan(0, 0, 0, 0)))
            {
                ...
                GridListControlHelper.Refresh<SellingDeliveryNotes>(this.gridList, _listOfSelling);
        ...
        protected override void Add()
        {
            using (new StCursor(Cursors.WaitCursor, new TimeSpan(0, 0, 0, 0)))
            {
                ...
                var frm = new FrmEntrySalesDeliveryNotes(formTitle + this.Text, _bll);
                frm.Listener = this;
                frm.ShowDialog();
            }            
        }
        ...
        protected override void Delete()
        {
            ...
            if (MsgHelper.MsgDelete())
            {
                using (new StCursor(Cursors.WaitCursor, new TimeSpan(0, 0, 0, 0)))
                {
                    ...
                    if (result > 0)
                    {
                        GridListControlHelper.RemoveObject<SellingDeliveryNotes>(this.gridList, _listOfSelling, sale);
                        ResetButton();
                    }
                    else
        ...
        {
            var sale = (SellingDeliveryNotes)data;

            if (isNewData)
            {
                GridListControlHelper.AddObject<SellingDeliveryNotes>(this.gridList, _listOfSelling, sale);
                ResetButton();
            }
            else
                GridListControlHelper.UpdateObject<SellingDeliveryNotes>(this.gridList, _listOfSelling, sale);
        }
