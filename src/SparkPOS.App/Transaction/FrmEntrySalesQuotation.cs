...
{
    public partial class FrmEntrySalesQuotation : FrmEntryStandard, IListener
    {
        private ISellingQuotationBll _bll = null;
        ...
        {            
            ...
            txtquotation.Text = bll.GetLastQuotation();
            ...
            : base()
        {
            ...
            txtquotation.Text = this._jual.quotation;
            ...
            {
                _listOfItemSellingOld.Add(new ItemSellingQuotation
                {
      ...
      //      }
           ...
           // _jual.is_cash = rdoCash.Checked;
            ...
            using (new StCursor(Cursors.WaitCursor, new TimeSpan(0, 0, 0, 0)))
            {
                ...
                //                    break;
                //                default:
                //                    PrintInvoice(_jual.quotation_id);
                //                    break;
                //            }
                //        }
                //    }
        ...
        public void Ok(object sender, object data)
        {
            if (data is Product) // pencarian product
            {
              ...
              //  cek item product already entered atau Not yet ?
                ...
                else
                {
                    ...
                    {
                        _listOfItemSelling.Add(new ItemSellingQuotation());
            ...
            else if (data is AddressShipping)
            {
                ...
                if (this._jual == null)
                    this._jual = new SellingQuotation();
        ...
        {
            ItemSellingQuotation itemSelling;

            if (_isNewData)
            {
                itemSelling = new ItemSellingQuotation();
            }
            else
            {
        ...
        private ItemSellingQuotation GetExistItemProduct(string produkId)
        {
