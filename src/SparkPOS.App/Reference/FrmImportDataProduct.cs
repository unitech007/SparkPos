...
{
    public partial class FrmImportDataProduct : FrmDialogImport
    {
        private const string ImportTitle = "Product";
        private ILog _log;

        public IListener Listener { private get; set; }

        public FrmImportDataProduct(string header)
            : base()
        {
        ...
        protected override void BrowseFileExcel()
        {
            ...
            using (var dlgOpen = new OpenFileDialog())
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    IImportExportDataBll<Product> importDataBll = new ImportExportDataProductBll(txtPath.Text, _log);
