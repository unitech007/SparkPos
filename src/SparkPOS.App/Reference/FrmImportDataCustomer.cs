...
namespace SparkPOS.App.Reference
{
    public partial class FrmImportDataCustomer : FrmDialogImport
    {
        ...
        {
            //var msg = "To open the {0} master file requires MS Excel Version 2007 or the latest.\n\n" +
            //          "Do you want the process to continue ?";
        ...
        protected override void ImportData()
        {
            ...
            {
                MsgHelper.MsgWarning("Location and file name Excel Not yet selected.");
                return;
            }
