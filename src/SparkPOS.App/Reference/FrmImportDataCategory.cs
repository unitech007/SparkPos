...
{
    public partial class FrmImportDataCategory : FrmDialogImport
    {
        private const string ImportTitle = "Category";
        private ILog _log;

        public IListener Listener { private get; set; }

        public FrmImportDataCategory(string header)
            : base()
        {
        ...
        protected override void OpenFileExcel()
        {
            ...
            if (MsgHelper.MsgConfirmation(string.Format(msg, ImportTitle)))
            {
                ...
                {
                    msg = "Sorry, master file {0} not found.";
      ...
      MsgHelper.MsgWarning(msg, ImportTitle);
        ...
        protected override void BrowseFileExcel()
        {
            ...
            using (var dlgOpen = new OpenFileDialog())
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    IImportExportDataBll<Category> importDataBll = new ImportExportDataCategoryBll(txtPath.Text, _log);
        ...
        protected override void ImportData()
        {
            ...
            if (txtPath.Text.Length == 0)
            {
                ...
                MsgHelper.MsgWarning("Excel file location and name not yet selected.");
                return;
            }
            ...
            if (importDataBll.IsOpened())
            {
                ...
                msg = "Sorry, master file {0} is currently open. Please close it first.";
                MsgHelper.MsgWarning(msg, ImportTitle);
            ...
            {
                msg = "Sorry, the {0} master file format is invalid. Import process cannot be continued.";
        MsgHelper.MsgWarning(msg, ImportTitle);
            ...
            if (MsgHelper.MsgConfirmation("Do you want the process to continue ?"))
            {
                using (new StCursor(Cursors.WaitCursor, new TimeSpan(0, 0, 0, 0)))
                {
                    ...
                    if (result)
                    {
                        msg = "Successfully imported {0} master data.";
