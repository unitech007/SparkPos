...
namespace SparkPOS.App.Reference
{
    ...
    {        
            ...
            : base()
        {
            ...
            txtAddress.Text = this._dropshipper.address;
            txtphone.Text = this._dropshipper.phone;
            MainProgram.GlobalLanguageChange(this);
        }
        ...
        protected override void Save()
        {
            ...
            _dropshipper.name_dropshipper = txtDropshipper.Text;
            _dropshipper.address = txtAddress.Text;
            _dropshipper.phone = txtphone.Text;
