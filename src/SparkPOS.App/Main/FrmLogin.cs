...
namespace SparkPOS.App.Main
{
    public partial class FrmLogin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            //if (IsTrialExpired())
            //{
            //    MsgHelper.MsgWarning("Your trial has expired. Please purchase a license to continue using the application.");
            //    return;
            //}
            ...
            try
            {
                ...
                using (new StCursor(Cursors.WaitCursor, new TimeSpan(0, 0, 0, 0)))
                {
                    ...
                    if (dbConn.IsTrialExpired())
                    {
                        var msg = "Your trial has expired. Please purchase a license to continue using the application.";
               ...
               MsgHelper.MsgError(msg);
                ...
                using (new StCursor(Cursors.WaitCursor, new TimeSpan(0, 0, 0, 0)))
                {
                    ...
                    {
                        var msg = "Incorrect user name or password !!!";
                        //  var msg = "CategoryNotSelected";
                        //var msg = "Incorrect user name or password !!!";
                        var translatedMessage = WarningMessageHandler.ShowTranslatedWarning(msg, MainProgram.currentLanguage);
                        MsgHelper.MsgWarning(translatedMessage);
                        txtUserName.Focus();
                    }
                }
            }
        ...
        private void rdBtnArabic_CheckedChanged(object sender, EventArgs e)
        {
