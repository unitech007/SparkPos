...
namespace SparkPOS.Helper
{
    public static class CryptoHelper
    {
        ...
        public static string GetTripleDESEncryptHash(string plainText, string key)
        {
            ...
            var Tcountrylgorithm = new TripleDESCryptoServiceProvider();

            // Step 3. Setup the encoder
            Tcountrylgorithm.Key = TDESKey;
            Tcountrylgorithm.Mode = CipherMode.ECB;
            Tcountrylgorithm.Padding = PaddingMode.PKCS7;
            ...
            try
            {
                ICryptoTransform Encryptor = Tcountrylgorithm.CreateEncryptor();
                Results = Encryptor.TransformFinalBlock(DataToEncrypt, 0, DataToEncrypt.Length);
            }
            finally
            {
                // Clear the TripleDes and Hashprovider services of any sensitive information
                Tcountrylgorithm.Clear();
                HashProvider.Clear();
            }

            // Step 6. Returnn the encrypted string as a base64 encoded string
        ...
        public static string GetTripleDESDecryptHash(string encryptText, string key)
        {
            ...
            try
            {
                ICryptoTransform Decryptor = Tcountrylgorithm.CreateDecryptor();
            ...
            // Step 6. Returnn the decrypted string in UTF8 format
