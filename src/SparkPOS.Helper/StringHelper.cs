...
namespace SparkPOS.Helper
{
    public static class StringHelper
    {
        ...
        public static string FixedLength(string s, int fixedLength)
        {
            ...
            var remaining = fixedLength - sLength;
        ...
        /// <summary>
        /// Fungsi untuk memecah string based karakter spasi
        /// </summary>
        ...
        /// <summary>
        /// Fungsi untuk memecah string based karakter yang diinginkan
        /// </summary>
        /// <param name="s">string yang ingin dipecah</param>
        /// <param name="index">index string yang diingin diambil</param>
        ...
        /// <summary>
        /// Fungsi untuk memecah string based quantity karakter yang diinginkan
        /// </summary>
        /// <param name="s"></param>
