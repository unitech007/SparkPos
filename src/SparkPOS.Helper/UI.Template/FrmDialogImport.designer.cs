namespace SparkPOS.Helper.UI.Template
{
    partial class FrmDialogImport
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtPath = new SparkPOS.Helper.UserControl.AdvancedTextbox();
            ...
            this.label7.Text = "Lokasi dan Name File Excel";
            ...
            this.label8.Text = "Select Worksheet";
            ...
            this.txtPath.Conversion = SparkPOS.Helper.UserControl.EConversion.Normal;
            ...
            // btnOpen
            // 
            this.btnOpen.Image = global::SparkPOS.Helper.Properties.Resources.open16;
    ...
    "ntoh File.";
            ...
            this.label6.Text = "3. Column-column pada Excel should not di merge atau di hide.";
            // 
            // label5
            // 
            ...
            this.label5.Text = "2. Pastikan file Excel menggunakan format Version 2007 atau yang Latest.";
            // 
            // label2
            // 
            ...
            this.label2.Text = "1. Susunan column pada Excel must sama dengan susunan column yang there pada program" +
    ".";
            // 
            // label1
            // 
    ...
    " Excel:";
        ...
        protected SparkPOS.Helper.UserControl.AdvancedTextbox txtPath;
    }
}